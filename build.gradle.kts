...
dependencies {
    ...
    implementation(group = "com.timoliacreative", name = "tranclate", version = "2.7.1")
    implementation(group = "com.timoliacreative", name = "tranclate-std-lib", version = "0.9.0-dev7")
